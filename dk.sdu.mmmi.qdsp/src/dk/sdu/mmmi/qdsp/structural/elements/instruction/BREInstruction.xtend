...
class BREInstruction extends dk.sdu.mmmi.qdsp.structural.elements.JumpInstruction{
	...
	override getComment()'''
	Absolute jump «jumpDestination» «jumpMode», if equal flag is set. Codeline «argument»'''
}